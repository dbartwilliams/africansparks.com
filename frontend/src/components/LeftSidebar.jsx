...
import { useShowNotifications } from "../tanstack/queries/notificationQueries";
...
const LeftSidebar = () => {
  ...
  const { data: notificationsData, isLoading, isError } = useShowNotifications({
  refetchInterval: 30000, // Check every 30 seconds
  refetchOnWindowFocus: true,
});

 // DEBUG
 console.log('LeftSidebar notifications:', {
...
// More debug
console.log('unreadCount value:', unreadCount, 'showBadge:', unreadCount > 0);
  ...
  const navItems = [
    ...
    { icon: Bell, label: 'Notifications', path: '/notification', showBadge: true },
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  {showBadge && (
                    <span className="absolute -top-2 -right-2 bg-[#5eeccc] text-black text-[14px] w-6 h-6 flex items-center justify-center rounded-full font-bold">
